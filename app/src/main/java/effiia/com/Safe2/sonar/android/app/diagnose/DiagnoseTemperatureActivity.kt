...
import effiia.com.Safe2.sonar.android.app.status.DisplayState
...
import effiia.com.Safe2.sonar.android.app.widgets.setRawText
...
open class DiagnoseTemperatureActivity : BaseActivity() {
    ...
    private fun setQuestionnaireContent() {
        if (isCheckinQuestionnaire()) {
            ...
            setTitle(R.string.temperature_question_simplified)
        } else {
            ...
            setTitle(R.string.temperature_question)
        }
    }
